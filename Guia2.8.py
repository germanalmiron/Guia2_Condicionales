...
"""
Ejercicio 8.
Ahora modifique el ejercicio anterior 
en el que además se conoce el número de cuotas en
la que paga, y aplicar los siguientes criterios 
para obtener el monto final (los recargos por
